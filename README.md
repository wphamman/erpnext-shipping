...
- **Unified manual carrier booking** — the order sidebar shows the customer-selected Courier Guy, MDS or TCG Locker service; a read-only live-cost check precedes the explicit booking confirmation
