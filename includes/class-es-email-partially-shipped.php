...
class ES_Email_Partially_Shipped extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->description    = __( 'Sent when part of an order has been shipped.', 'erpnext-shipping' );
        $this->heading        = __( 'Part of your order has been shipped', 'erpnext-shipping' );
        $this->subject        = __( 'Your order #{order_number} has been partially shipped', 'erpnext-shipping' );
        $this->template_html  = 'emails/es-partially-shipped.php';
        $this->template_plain = 'emails/plain/es-partially-shipped.php';
