<?php
/**
 * Dispatched to Pickup email template.
 *
 * Override by copying to: yourtheme/woocommerce/emails/es-dispatched-pickup.php
 *
 * @var WC_Order $order
 * @var array    $pickup_location  Location data array (name, street, city, etc.)
...
<p><?php esc_html_e( "Your order has been dispatched to your selected pickup location. We'll notify you when it's ready to collect.", 'erpnext-shipping' ); ?></p>
...
?>
<p style="background:#f8f8f8; padding:12px; border-left:4px solid #5b9bd5; margin:16px 0;">
