<?php
/**
 * Dispatched to Pickup plain text email.
 *
 * Override by copying to: yourtheme/woocommerce/emails/plain/es-dispatched-pickup.php
 */
...
echo "\n\n";
esc_html_e( "Your order has been dispatched to your selected pickup location. We'll notify you when it's ready to collect.", 'erpnext-shipping' );
echo "\n\n";
...
if ( ! empty( $pickup_location ) ) {
	...
	esc_html_e( 'Pickup location:', 'erpnext-shipping' );
	echo "\n" . implode( ', ', array_map( 'esc_html', $parts ) ) . "\n";
